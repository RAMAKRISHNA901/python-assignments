...
myfunc(name="aman",msg="good afternoon")
myfunc(msg="good afternoon",name="aman")
...
def ram(name,msg):
    print("hello",name,msg)
ram(name="hii rama krishna",msg="good afternoon")
ram(msg="good afternoon",name="hi rama krishna ")
...
myfunc(name="aman",roll ="1234")
myfunc(roll="1234",name="aman")

#
print()
def myfunc(name,msg):
    print("welcome",name,msg)
myfunc(name="hello",msg="raju ")
myfunc(msg="how are you",name="aman")
